    ...
    ?>
        ...
        ?>
            ...
            <div class="form-group col-12">
                ...
                <div class="col-sm-10">
                <input name="paymentName" type="text" class="form-control" id="Name" placeholder="Name On Cart" required>
                </div>
            </div>
            <div class="form-group col-6">
                <label for="cartNum" >Number on Card</label>
                <div class="col-sm-10">
                <input name="paymentNum" type="number" class="form-control"  id="cartNum" placeholder="6474-5767-6832-3913" pattern="[0-9]{4}[0-9]{4}[0-9]{4}[0-9]{4}"  required>
                </div>
            </div>
            ...
            <div class="col-1">
                <button style="background-color:white; color: rgb(33, 17, 55);" class="col-12  bg-darkk shadow-lg rounded total"  type="submit" name="Save_payment" >
                    <a style="text-decoration: none; color: rgb(33, 17, 55);" href="./chose_Table_for_insert.php">Back</a>
                </button>   
            </div>

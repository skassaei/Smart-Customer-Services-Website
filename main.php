  ...
  <script>
    ...
    app.config(function($routeProvider) {
      $routeProvider
        ...
        .when("/logout", {
          templateUrl: "DB_Operations/logout.php"
        })
        .when("/shoppingcart", {
    ...
    app.controller('MyController', function($scope, $http, $window) {
      $scope.confirmPayment = function() {
        ...
        // for example, make an HTTP POST request to a server-side API
        $http.post('/api/confirm-payment', {
          ...
          .then(function(response) {
            ...
            $window.location.href = './Forms/paymentForm.php';
          }, function(error) {
            console.error(error);
          });
      }
    ...
    app.controller('MyController', function($scope, $http, $location) {
      $scope.submitForm = function() {
        $http.post('./Forms/paymentForm.php', {
            data: $scope.formData
          })
          .then(function(response) {
            // handle success

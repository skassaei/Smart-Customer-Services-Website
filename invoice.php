    ...
    <body>
        ...
        <?php
            ...
            while(empty($avTruck)){
              ...
              $Find_avTruck = "SELECT truckID FROM trucktogo WHERE $deliveryDateWeek != 0";
              $avTruck_run= mysqli_query($conn, $Find_avTruck);
              $avTruck= mysqli_fetch_row($avTruck_run);
            }
            $Find_avDay = "SELECT $deliveryDateWeek FROM trucktogo WHERE truckID = $avTruck[0]";
                ...
                <table class="col-12">
                    ...
                    <?php
                        ...
                        while ($itemsID= mysqli_fetch_row($items_run)){
                            ...
                            // $Find_discountItemID = "SELECT itemID FROM discount WHERE itemID='$itemsID[0]'";
